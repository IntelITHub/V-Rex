...
- (id)initWithTitle:(NSString *)title message:(NSString *)message delegate:(id)AlertDelegate cancelButtonTitle:(NSString *)cancelButtonTitle otherButtonTitle:(NSString *)otherButtonTitle
{
    ...
    if (self) {
        ...
        UIImage *CancelBtnImg = [UIImage imageNamed:@"alert_cancel.png"];
        UIImage *OtherBtnImg = [UIImage imageNamed:@"alert_ok.png"];
        UIImage *cancelBtnImgsingle = [UIImage imageNamed:@"alertviewok"];
        ...
        //add text
        UILabel *TitleLbl;
        UIScrollView *MsgScrollView = nil;
        
        if (title)
        {
            TitleLbl = [[UILabel alloc] initWithFrame:CGRectMake(0.0, alert_height, alert_width, 30.0)];
            TitleLbl.adjustsFontSizeToFitWidth = YES;
            TitleLbl.font = [UIFont boldSystemFontOfSize:18.0];
            TitleLbl.textAlignment = 1;
//            TitleLbl.minimumFontSize = 12.0;
            TitleLbl.minimumScaleFactor = 12.0;
        ...
        if (message)
        {
            ...
            UILabel *MessageLbl = [[UILabel alloc] initWithFrame:CGRectMake(10.0, 0.0, alert_width-30.0, 0.0)];
            MessageLbl.numberOfLines = 0;
            MessageLbl.font = [UIFont systemFontOfSize:16.0];
            MessageLbl.textAlignment = 1;//UITextAlignmentCenter;
            MessageLbl.backgroundColor = [UIColor clearColor];
            MessageLbl.textColor = [UIColor blackColor];
            MessageLbl.text = message;
            
            [MessageLbl sizeToFit];
            MessageLbl.frame = CGRectMake(10.0, 0.0, alert_width-30.0, MessageLbl.frame.size.height);
        ...
        if (cancelButtonTitle && otherButtonTitle)
        {
            ...
            CancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(x_displ, alert_height+15, CancelBtnImg.size.width, CancelBtnImg.size.height)];
            
            [CancelBtn setTag:1000];
            [CancelBtn setTitle:cancelButtonTitle forState:UIControlStateNormal];
            [CancelBtn setTitleColor:[UIColor blackColor] forState:(UIControlStateNormal)];
            [CancelBtn.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:15.0]];
            ...
            OtherBtn = [[UIButton alloc] initWithFrame:CGRectMake(x_displ*2+CancelBtnImg.size.width, alert_height+15, OtherBtnImg.size.width+1, OtherBtnImg.size.height)];
            ...
            [OtherBtn.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:15.0]];
        ...
        {
            CancelBtn = [[UIButton alloc] initWithFrame:CGRectMake((int)0.0, alert_height+15, cancelBtnImgsingle.size.width, cancelBtnImgsingle.size.height)];
            [CancelBtn setTag:1000];
            [CancelBtn setTitle:cancelButtonTitle forState:UIControlStateNormal];
            [CancelBtn setTitleColor:[UIColor blackColor] forState:(UIControlStateNormal)];
            [CancelBtn.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:15.0]];
            [CancelBtn setBackgroundImage:cancelBtnImgsingle forState:UIControlStateNormal];
        ...
        {
            OtherBtn = [[UIButton alloc] initWithFrame:CGRectMake((int)((alert_width-OtherBtnImg.size.width)/2.0), alert_height+10, OtherBtnImg.size.width, OtherBtnImg.size.height)];
            [OtherBtn setTag:1001];
            [OtherBtn setTitle:otherButtonTitle forState:UIControlStateNormal];
            [OtherBtn setTitleColor:[UIColor blackColor] forState:(UIControlStateNormal)];
            [OtherBtn.titleLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Light" size:15.0]];
...
-(void)showTextField:(UITextField *)txtField {   
    ...
    [self performSelector:@selector(showtext1:) withObject:txtField afterDelay:0.0];

}

-(void)showtext1:(UITextField *)txtField{
